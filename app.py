...
AI-driven freight cost prediction and invoice risk flagging tool.
Leverages machine learning to forecast freight costs accurately
and flag risky invoices for manual approval.
""")
...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**  
    ...
    if submit_freight:
        ...
        prediction = predict_freight_cost(input_data)['predicted_freight_cost'].iloc[0]
...
# ================================================================
    ...
    **Objective:**  
    ...
    if submit_flag:
        ...
        flag_prediction = predict_invoice_flag(input_data)['predicted_invoice_flag'].iloc[0]
